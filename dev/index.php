                                      ...
                                      cabanaskaialua.uni5.net <span class="caret pull-right"></span>
                                        ...
                                        <div class="collapse" id="dominio555435" style="height: 0px;">
                                            <ul class="nav nav-list">
                                                <li><a href="http://localhost/painel-sitehospedo/dev/dominios/index/?dominio=555435"><i class="fa fa-envelope"></i> Emails</a></li>
                                    ...
                                    <li>
                                      ...
                                      campanarigaleteria.com.br <span class="caret pull-right"></span>
                                        ...
                                        <div class="collapse" id="dominio555962" style="height: 0px;">
                                            <ul class="nav nav-list">
                                                <li><a href="http://localhost/painel-sitehospedo/dev/dominios/index/?dominio=555962"><i class="fa fa-envelope"></i> Emails</a></li>
                                                <li><a href="#"><i class="fa fa-globe"></i> Site</a></li>
                                            </ul>
                                        </div>
                                    </li>
                                    ...
                                    <li>
                                      ...
                                      complexb.com.br <span class="caret pull-right"></span>
                                        ...
                                        <div class="collapse" id="dominio524663" style="height: 0px;">
                                            <ul class="nav nav-list">
                                                <li><a href="http://localhost/painel-sitehospedo/dev/dominios/index/?dominio=524663"><i class="fa fa-envelope"></i> Emails</a></li>
                                                <li><a href="#"><i class="fa fa-globe"></i> Site</a></li>
                                            </ul>
                                        </div>
                                    </li>
                                    ...
                                    <li>
                                      ...
                                      gbrand.com.br <span class="caret pull-right"></span>
                                        ...
                                        <div class="collapse" id="dominio308225" style="height: 0px;">
                                            <ul class="nav nav-list">
                                                <li><a href="http://localhost/painel-sitehospedo/dev/dominios/index/?dominio=308225"><i class="fa fa-envelope"></i> Emails</a></li>
                                                <li><a href="#"><i class="fa fa-globe"></i> Site</a></li>
                                            </ul>
                                        </div>
                                    </li>
                                    ...
                                    <li>
                                      ...
                                      godown.com.br <span class="caret pull-right"></span>
                                        ...
                                        <div class="collapse" id="dominio56812" style="height: 0px;">
                                            <ul class="nav nav-list">
                                                <li><a href="http://localhost/painel-sitehospedo/dev/dominios/index/?dominio=56812"><i class="fa fa-envelope"></i> Emails</a></li>
                                                <li><a href="#"><i class="fa fa-globe"></i> Site</a></li>
                                            </ul>
                                        </div>
                                    </li>
                                    ...
                                    <li>
                                      ...
                                      helpdesign.com.br <span class="caret pull-right"></span>
                                        ...
                                        <div class="collapse" id="dominio448652" style="height: 0px;">
                                            <ul class="nav nav-list">
                                                <li><a href="http://localhost/painel-sitehospedo/dev/dominios/index/?dominio=448652"><i class="fa fa-envelope"></i> Emails</a></li>
                                                <li><a href="#"><i class="fa fa-globe"></i> Site</a></li>
                                            </ul>
                                        </div>
                                    </li>
                                    ...
                                    <li>
                                      ...
                                      regenciadho.com.br <span class="caret pull-right"></span>
                                        ...
                                        <div class="collapse" id="dominio556771" style="height: 0px;">
                                            <ul class="nav nav-list">
                                                <li><a href="http://localhost/painel-sitehospedo/dev/dominios/index/?dominio=556771"><i class="fa fa-envelope"></i> Emails</a></li>
                                                <li><a href="#"><i class="fa fa-globe"></i> Site</a></li>
                                            </ul>
                                        </div>
                                    </li>
                                    ...
                                    <li>
                                      ...
                                      sitehospedo.com.br <span class="caret pull-right"></span>
                                        ...
                                        <div class="collapse" id="dominio545328" style="height: 0px;">
                                            <ul class="nav nav-list">
                                                <li><a href="http://localhost/painel-sitehospedo/dev/dominios/index/?dominio=545328"><i class="fa fa-envelope"></i> Emails</a></li>
                                                <li><a href="#"><i class="fa fa-globe"></i> Site</a></li>
                                            </ul>
                                        </div>
                                    </li>
                                    ...
                                    <li>
                                      ...
                                      testegbrand.com.br <span class="caret pull-right"></span>
                                        ...
                                        <div class="collapse" id="dominio562306" style="height: 0px;">
                                            <ul class="nav nav-list">
                                                <li><a href="http://localhost/painel-sitehospedo/dev/dominios/index/?dominio=562306"><i class="fa fa-envelope"></i> Emails</a></li>
                                                <li><a href="#"><i class="fa fa-globe"></i> Site</a></li>
                                            </ul>
                                        </div>
                                    </li>
