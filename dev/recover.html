...
<body id="login">
    <img src="assets/img/logos/logo-s-icone-colorido-md.png" alt="">

    <div class="sth-login-form recover">
        <div class="row">
            ...
            <div class="form">
                <form action="">
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="botao">
                                <button type="submit" class="btn btn-md btn-roxo-full" id="enviar">Relembrar senha <i class="fa fa-paper-plane"></i></button>
                            </div>
                            <div class="recuperar">
                                <a href="login.html">Voltar e fazer Login</a>
                            </div>
                        </div>
    ...
    <img src="assets/img/logos/logo-icone.png" class="sth-icone-bottom" alt="">
